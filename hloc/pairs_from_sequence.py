...
# Notes (Lasse): Adapted from https://github.com/hugoycj/light-hloc/blob/master/lighthloc/associators/pairs_from_sequance.py [sic!].
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=("Create a list of image pairs based on the "
                                                  "sequence of images on alphabetic order"))
